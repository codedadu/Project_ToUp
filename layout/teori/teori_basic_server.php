    ...
    <tr>
        <td class="upfortitle" style="text-align: center; background-color: #FF9800; color: white;"><b>1</b></td>

        <td class="upfortitle" style="background-color: #FF9800; color: white;"><b style="text-transform: uppercase;">Basic Management Server</b></td>
        ...
        <td class="centerpos"> <?php echo $pg_soal_bs ?> </td>
        <td class="centerpos" colspan=2> <?php echo $nilai_pg_bs ?> </td>
    </tr>
    <tr>
        <td colspan="3"></td>
        <td class="leftbor"  id="list"> 2 </td>
        <td class="upfortitle">Essay</td>
        <td class="centerpos"> <?php echo $essay_soal_bs ?> </td>
        <td class="centerpos" colspan=2> <?php echo $nilai_essay_bs ?> </td>
    </tr>
    <tr>
        <td colspan="3"></td>
        <td class="leftbor"  id="list"> 3 </td>
        <td class="upfortitle">Total</td>
        <td class="centerpos"> <?php echo $totalsoal_teori_bs ?> </td>
        <td class="centerpos" title="Total didapat dari: Nilai Essay * 8 + Nilai PG" colspan=2> <?php echo $totalnilai_teori_bs ?>%</td>
    </tr>
